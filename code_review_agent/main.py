...
async def process_pull_request(repo: str, pr_number: int, commit_sha: str):
    ...
    try:
        ...
        for file_info in reviewable_files:
            ...
            # Surface file-level style suggestions in the PR-level summary
            # rather than discarding them. They were being parsed off the LLM
            # response already; this just connects the wiring.
...
def generate_review_summary(
    ...
    # Add aggregated style suggestions (deduplicated, truncated to keep the
    # summary compact). Without this section the parser-level field on
    # FileReviewResult would be populated but never surfaced anywhere.
